class HomePageModelResp {
  int code;
  String msg;
  HomePageModel data;

  HomePageModelResp({this.code, this.msg, this.data});

  HomePageModelResp.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    msg = json['msg'];
    data =
        json['data'] != null ? new HomePageModel.fromJson(json['data']) : null;
  }
